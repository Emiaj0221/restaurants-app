...
const NewRestaurant = ({ onRestaurantAdded }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.priceRange)
      newErrors.priceRange = "Selecciona un rango de precio";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(" Restaurante guardado exitasamente");

      navigate("/");
    } catch (error) {
      console.error("Error al guardar el restaurante:", error);
      setErrors({
        submit: "Error al guardar el restaurante. Inténtalo de nuevo.",
      });
    } finally {
  ...
  return (
    <div className="container container-new-restaurant">
      ...
      <form className="restaurant-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="Describe el restaurante, su ambiente y especialidades..."
          />
          {errors.description && (
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <select
              ...
              onChange={handleChange}
              className={`form-select ${errors.priceRange ? "error" : ""}`}
            >
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="0.0"
            />
            <small> De 0.0 a 5.0 estrellas</small>
          </div>
        </div>
        <div className="form-group">
